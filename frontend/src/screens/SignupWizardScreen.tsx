...
export default function SignupWizardScreen({ t }: { t: Theme }) {
    ...
    >
      ...
      >
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline", marginTop: 8 }}>
          <div>
            <div style={{ fontSize: "clamp(20px, 5vw, 24px)", fontWeight: 900 }}>Sign up</div>
            <div style={{ fontSize: 12, color: t.textMuted, marginTop: 4 }}>
              Step {step} of 5
            </div>
          </div>
          <div style={{ fontSize: 12, color: t.textMuted, fontWeight: 900 }}>{progress}%</div>
        </div>
        ...
        {step === 2 && (
          <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
            <div style={{ fontSize: 13, color: t.textMuted }}>Tell us about you.</div>
        ...
        {step === 3 && (
          <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
            <div style={{ fontSize: 13, color: t.textMuted }}>Where do you study?</div>
      ...
      <div style={{ display: "flex", gap: 10, marginTop: 16 }}>
        ...
        <div style={{ marginTop: 14, fontSize: 11, color: t.textMuted }}>
          We use Supabase Auth when configured; otherwise demo auth (localStorage).
        </div>
      </div>
    </div>
  );
